      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-12 items-center gap-4 sm:gap-6 lg:gap-8">
        <div className="col-span-7 lg:col-span-7 flex flex-col items-start text-left z-20">
          ...
          <motion.h1
            ...
            className="editorial-title mb-4 sm:mb-8"
          >
            Blessing <br />
          ...
          >
            {[
              ...
              },
              {
                ...
                svg: (
                  <svg className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 fill-current" viewBox="0 0 24 24">
              ...
              <a
                ...
                className={`w-8 h-8 sm:w-11 sm:h-11 rounded-full border flex items-center cursor-pointer justify-center transition-all duration-300 shadow-sm hover:-translate-y-1 ${social.baseStyle}`}
              >
                {social.svg}
              </a>
            ))}
