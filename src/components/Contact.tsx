...
export default function Contact() {
  // Pre-filled email parameters to make it effortless for her clients
  const emailAddress = "Blessing9604@gmail.com";
  const emailSubject = encodeURIComponent("Inquiry: Creative Collaboration / Booking");
  const emailBody = encodeURIComponent("Hi Blessing,\n\nI love your portfolio and would like to discuss working together on a project...");
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 relative z-10">
            ...
            <div className="md:col-span-6 flex flex-col justify-between">
              ...
              {/* Primary Contact Link - FIXED: Added proper mailto syntax with matching email */}
              <motion.a 
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-xl font-bold text-primary/90 tracking-wide break-all transition-colors group-hover:text-primary">
                    {emailAddress}
                  </span>
                </div>
              </motion.a>
